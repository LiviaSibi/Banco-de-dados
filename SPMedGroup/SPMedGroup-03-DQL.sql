...
--Select documento (**ARRUMAR DATA CONSULTA**)
SELECT Prontuarios.Nome as Prontuario, Prontuario.RG, Medicos.Nome as Medico, Medico.Especializacao as Especializacao, Clinica.NomeFantasia, Clinica.RazaoSocial,
DataConsulta, Situacao.Titulo as Situacao
FROM Consulta
