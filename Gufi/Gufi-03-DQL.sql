...
SELECT Eventos.NomeEvento, TipoEvento.TipoEvento, Eventos.DataEvento, Eventos.AcessoLivre, Eventos.Descricao, Usuarios.NomeUsuario, Instituicao.NomeFantasia
FROM  Presencas
